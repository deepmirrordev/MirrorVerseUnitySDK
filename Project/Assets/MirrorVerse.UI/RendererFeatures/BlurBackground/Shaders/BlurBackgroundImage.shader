Shader "MirrorVerse/BlurBackgroundImage"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            half4 frag(v2f IN) : SV_Target
            {
                ...
                blurTexcoord = getCroppedCoord(blurTexcoord, cropRegion);

                half3 backgroundColor = UNITY_SAMPLE_SCREENSPACE_TEXTURE(_BlurTex, UnityStereoTransformScreenSpaceTex(blurTexcoord)).rgb;
